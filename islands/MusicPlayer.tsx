...
export default function MusicPlayer() {
  ...
  return (
    <div class="fixed bottom-8 right-8 z-50 flex flex-col items-end gap-4">
      ...
      <div 
        class={`
          relative flex items-center gap-4 bg-white/5 backdrop-blur-xl border border-white/10 p-4 rounded-2xl shadow-2xl 
      ...
      >
        ...
        {hasStarted && playlist.length > 0 && (
          <div class="flex flex-col w-32 overflow-hidden relative group/text">
            ...
            <div class="relative w-full h-5 overflow-hidden">
               <div class="whitespace-nowrap absolute animate-marquee group-hover/text:paused">
                <span class="text-[11px] font-medium text-white/60 mr-8 align-middle">
        ...
        <div class="flex items-center gap-2">
          ...
          <button
            type="button"
            onClick={togglePlay}
            class="w-10 h-10 flex items-center justify-center bg-cyan-500 rounded-xl text-black hover:bg-cyan-400 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-cyan-500/20"
          ...
          >
            {isPlaying.value ? (
              ...
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" class="ml-1">
      ...
      >
        <button
          ...
          className="w-12 h-12 flex items-center justify-center bg-cyan-500/20 backdrop-blur-md border border-cyan-500/50 rounded-full text-cyan-400 hover:bg-cyan-500 hover:text-black transition-all shadow-lg hover:shadow-cyan-500/50 animate-pulse"
